...
typedef void (*grasp_cost) (grasp* g, void* elements, int n_elements, float* costs);
typedef void (*grasp_candidates) (grasp* g, void* elements, int n_elements, int* solution, int n_solution, bool* candidates);
typedef void (*grasp_compare) (grasp* g, void* elements, int* solution, int n_solution, int* best_solution, int* n_best_solution);
